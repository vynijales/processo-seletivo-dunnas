...
CREATE TABLE IF NOT EXISTS salas (
    ...
    -- Deleção em cascata: se um setor for deletado, todas as salas associadas a ele também serão deletadas
    CONSTRAINT fk_salas_setor FOREIGN KEY (setor_id) REFERENCES setores(id) ON DELETE CASCADE,
